  ...
  return (
    <div className={className}>
      <svg viewBox="0 0 150 150" width="150pt" height="150pt">
        <g>
          <path
            d=" M 52.188 82 L 71.313 111.5 L 85.313 111.5 L 85.313 92.25 L 75.313 83.25 L 75.313 99.5 L 63.656 82 L 52.188 82 Z "
            // fill="rgb(0,0,0)"
          />
          <path
          ...
          />
          <path
            d=" M 24.313 67.313 L 24.313 38.5 L 24.313 38.5 L 63.906 38.5 L 63.656 47.5 L 34.563 47.5 L 34.563 67.313 L 24.313 67.313 Z "
            // fill="rgb(0,0,0)"
          />
        </g>
      </svg>
