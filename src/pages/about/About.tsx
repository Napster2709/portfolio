    ...
    <div className={styles.section}>
      <Grid fluid>
        <Grid.Column cols={5} className={cn(styles.about)}>
          ...
          <Line className={cn(styles.line, styles.slideRight)} align="right" />
        ...
        <Grid.Column cols={7} className={cn(styles.text, styles.slideRight)}>
          <p>
            ...
            distinctio sapiente possimus esse eius voluptates rerum optio unde,
            deserunt in. Veniam, amet? Illum ducimus praesentium placeat
            ...
            elit. Dicta distinctio sapiente possimus esse eius voluptates rerum
            optio unde, deserunt in. Veniam, amet? Illum ducimus praesentium
            placeat explicabo itaque unde reprehenderit. Lorem, ipsum dolor sit
            amet consectetur adipisicing elit. Dicta distinctio sapiente
            possimus esse eius voluptates rerum optio unde, deserunt in. Veniam,
            amet? Illum ducimus praesentium placeat explicabo itaque unde
            reprehenderit. Lorem, ipsum dolor sit amet consectetur adipisicing
            elit. Dicta distinctio sapiente possimus esse eius voluptates rerum
